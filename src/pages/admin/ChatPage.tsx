...
export function ChatPage() {
  ...
  return (
    <div className={`chat-view ${selectedUserId ? 'chat-view--has-active-session' : ''}`}>
      ...
      <div className="chat-view__main">
        {selectedUserId ? (
          <>
            <div className="chat-view__main-header" style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              <button 
              ...
              <span>Chatting with {sessions.find(s => s.user_id === selectedUserId)?.first_name || selectedUserId}</span>
            </div>
